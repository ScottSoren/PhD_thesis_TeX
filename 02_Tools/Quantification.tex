...
\footnote{External calibration is implemented with the function \texttt{point\_calibration} of the \texttt{EC\_MS} python package (Appendix \ref{app:EC_MS}).}
...
\begin{itemize}
	...
	\footnote{Chip calibration is implemented with the function \texttt{chip\_calibration} of the \texttt{EC\_MS} python package (Appendix \ref{app:EC_MS})}
	, Subsection \ref{subsec:capillary}:
